...
#define LIN_1_SCB_SPI_INTR_RX_MASK           (0x0u)
#define LIN_1_SCB_SPI_INTR_TX_MASK           (0x0u)
...
#define LIN_1_SCB_UART_MP_RX_ADDRESS         (0x2u)
#define LIN_1_SCB_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define LIN_1_SCB_UART_INTERRUPT_MODE        (2u)

#define LIN_1_SCB_UART_INTR_RX_MASK          (0x0u)
#define LIN_1_SCB_UART_INTR_TX_MASK          (0x0u)
...
#define LIN_1_SCB_UART_RX_BREAK_WIDTH        (11u)
...
***************************************/
    ...
    #define LIN_1_SCB_UART_DEFAULT_UART_RX_CTRL \
                    (LIN_1_SCB_GET_UART_RX_CTRL_MODE(LIN_1_SCB_UART_STOP_BITS_NUM)                    | \
                     ...
                     LIN_1_SCB_GET_UART_RX_CTRL_BREAK_WIDTH(LIN_1_SCB_UART_RX_BREAK_WIDTH)            | \
