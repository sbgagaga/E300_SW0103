...
#define LIN_1_SCB_COMP_VERSION_MAJOR    (4)
#define LIN_1_SCB_COMP_VERSION_MINOR    (0)
...
*/
#define LIN_1_SCB_SCB_SW_RESET   LIN_1_SCB_I2CFwBlockReset()
...
#define LIN_1_SCB_DISABLE_AUTO_DATA \
                do{                        \
                    LIN_1_SCB_I2C_CTRL_REG &= ((uint32) ~(LIN_1_SCB_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 LIN_1_SCB_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 LIN_1_SCB_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 LIN_1_SCB_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define LIN_1_SCB_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    LIN_1_SCB_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    LIN_1_SCB_UART_RX_CTRL_BREAK_WIDTH_MASK)
...
#define LIN_1_SCB_GET_TX_CTRL_DATA_WIDTH(dataWidth)  (((uint32) (dataWidth) - 1u) & \
                                                                LIN_1_SCB_TX_CTRL_DATA_WIDTH_MASK)
