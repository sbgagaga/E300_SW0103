...
#define EZI2C_1_EZI2C_PRIMARY_SLAVE_ADDRESS    (0x8u)
#define EZI2C_1_EZI2C_SECONDARY_SLAVE_ADDRESS  (0x9u)
#define EZI2C_1_EZI2C_SUB_ADDRESS_SIZE         (1u)
#define EZI2C_1_EZI2C_WAKE_ENABLE              (0u)
#define EZI2C_1_EZI2C_DATA_RATE                (400u)
#define EZI2C_1_EZI2C_SLAVE_ADDRESS_MASK       (0xFEu)
...
/* Access to global variables */
    ...
    #define EZI2C_1_EZI2C_SET_OFFSET(activeAddress, locOffset) \
            do{ \
                if(EZI2C_1_EZI2C_ACTIVE_ADDRESS1 == (activeAddress)) \
                {    \
                    EZI2C_1_offsetBuf1 = (uint16) (locOffset); \
                }    \
                else \
                {    \
                    EZI2C_1_offsetBuf2 = (uint16) (locOffset); \
                }    \
            }while(0)
#else
