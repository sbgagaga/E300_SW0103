...
`ifdef WARP
`define CY_BLK_DIR "D:\cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "D:\cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`else
`define CY_BLK_DIR "D:\cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50"
`include "D:\cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\Bus_Connect_v2_50\Bus_Connect_v2_50.v"
`endif
...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("fe680122-fa5b-41de-9c8f-e9440b239379/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module CapSense_P4_v6_0_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f1eee7e0-8176-4ec6-a8ac-0e15c3480c11/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("OK_Sns0,Down_Sns0,SeekReduce_Sns0,SeekPlus_Sns0,Up_Sns0,Ret_Sns0"),
		  .pin_mode("AAAAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f1eee7e0-8176-4ec6-a8ac-0e15c3480c11/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("f1eee7e0-8176-4ec6-a8ac-0e15c3480c11/a8285cdc-5e81-40c0-8036-58ea5f8c1102"),
...
module SCB_P4_v4_0_3 (
	...
	cy_clock_v1_0
		#(.id("1a32949f-6dd7-43a6-bca1-ca1faba20fee/2dc2d7a8-ce2b-43c7-af4a-821c8cd73ccf"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("127877237.851662"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a32949f-6dd7-43a6-bca1-ca1faba20fee/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1a32949f-6dd7-43a6-bca1-ca1faba20fee/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    CapSense_P4_v6_0_1 CapSense_1 ();

    SCB_P4_v4_0_2 I2C_Slave (
        .cts_in(1'b0),
        .rts_out(Net_285),
        .interrupt(Net_286),
        .clock(1'b0),
	...
	cy_clock_v1_0
		#(.id("42336d8d-1667-4341-9bc6-1c41134781b4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9503b8a4-426b-4019-b137-399e49a8ef05"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__VolPlus_in_net;
	wire [0:0] tmpFB_0__VolPlus_in_net;
	wire [0:0] tmpIO_0__VolPlus_in_net;
	wire [0:0] tmpINTERRUPT_0__VolPlus_in_net;
	electrical [0:0] tmpSIOVREF__VolPlus_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		VolPlus_in
		 (.oe(tmpOE__VolPlus_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VolPlus_in_net[0:0]}),
		  .io({tmpIO_0__VolPlus_in_net[0:0]}),
		  .siovref(tmpSIOVREF__VolPlus_in_net),
		  .interrupt({tmpINTERRUPT_0__VolPlus_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VolPlus_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mute_in_net;
	wire [0:0] tmpFB_0__Mute_in_net;
	wire [0:0] tmpIO_0__Mute_in_net;
	wire [0:0] tmpINTERRUPT_0__Mute_in_net;
	electrical [0:0] tmpSIOVREF__Mute_in_net;

	cy_psoc3_pins_v1_10
		#(.id("dd66565e-92fa-490c-a3ab-a5fccc55a764"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Mute_in
		 (.oe(tmpOE__Mute_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mute_in_net[0:0]}),
		  .io({tmpIO_0__Mute_in_net[0:0]}),
		  .siovref(tmpSIOVREF__Mute_in_net),
		  .interrupt({tmpINTERRUPT_0__Mute_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mute_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VolReduce_in_net;
	wire [0:0] tmpFB_0__VolReduce_in_net;
	wire [0:0] tmpIO_0__VolReduce_in_net;
	wire [0:0] tmpINTERRUPT_0__VolReduce_in_net;
	electrical [0:0] tmpSIOVREF__VolReduce_in_net;

	cy_psoc3_pins_v1_10
		#(.id("857ae2fc-5b2e-44e5-b47f-4be96a465abc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		VolReduce_in
		 (.oe(tmpOE__VolReduce_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VolReduce_in_net[0:0]}),
		  .io({tmpIO_0__VolReduce_in_net[0:0]}),
		  .siovref(tmpSIOVREF__VolReduce_in_net),
		  .interrupt({tmpINTERRUPT_0__VolReduce_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VolReduce_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
